...
*Language: **English** · [Türkçe](INTEGRATION.md)*
...
> Tailscale) see [`NETWORK.md`](NETWORK.md) *(currently Turkish — ask if you need
> it in English)*; for the normative rules see the
...
[`../kio2-integration/README.md`](../kio2-integration/README.md), currently Turkish.)
